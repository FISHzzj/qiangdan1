<?php defined('IN_IA') or exit('Access Denied');?>f<?php (!empty($this) && $this instanceof WeModuleSite) ? (include $this->template('common/header', TEMPLATE_INCLUDEPATH)) : (include template('common/header', TEMPLATE_INCLUDEPATH));?>
...
.my_int .num2 {height: 20px;line-height: 20px;color: #fff;font-size: 20px;}
...
<script id='tpl_main' type='text/html'>
 <div class="page_topbar">
    ...
    <div class="my_int">
        ...
        <div class="num2"><?php  echo $credit;?></div>
    </div>
    </div>
