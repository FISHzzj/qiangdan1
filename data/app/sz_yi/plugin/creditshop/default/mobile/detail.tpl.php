...
<style type='text/css'>
    ...
    .addorder_user {float:left;width:100%;  background:#fff; border-bottom:1px solid #eaeaea; }
    ...
    .addorder_user .info .info1 .inner .user {padding-left:15px; width:100%; font-size:16px; color:#333; line-height:35px;overflow:hidden;}
    ...
    .addorder_user .info .ico2 {height:50px; width:30px;padding-right:8px;padding-top:15px; float:right; font-size:16px; text-align:right; color:#999;}
  
    .chooser { overflow: auto; width: 100%; background:#efefef; position: fixed; top: 0px; right: -100%; z-index: 999;}
    .chooser .store {height:50px; background:#fff; padding:0 10px;; border-bottom:1px solid #eaeaea;}
    ...
    .chooser .store .info {height:50px; width:100%;float:left;margin-left:-30px;margin-right:-70px;}
    ...
    .chooser .store .edit {height:50px; width:60px; float:right;margin-left:-30px;text-align:center;line-height:50px;color:#666;}
  ...
  .carrier_input_info {height:auto;width:100%; background:#fff; margin-top:14px;  border-top:1px solid #e8e8e8;}
    .carrier_input_info .row { padding:0 30px; height:40px; background:#fff; border-bottom:1px solid #e8e8e8; line-height:40px; color:#999;}
...
<script type='text/html' id='tpl_main'>
  ...
  data-address='<%store.address%>' 
    ...
    <div class="title">商品详情</div>
      ...
      <img src="<%goods.thumb%>"/>
        ...
        <div class="info_price">
            <div class="num2">
            <%if goods.acttype==0%>
                 <%goods.credit%><i class="fa fa-database" style="margin-left: 5px;"></i> <i class="fa fa-plus" style='color:#999;'></i> <%goods.money%><i class="fa fa-rmb" ></i>
            <%/if%>
            <%if goods.acttype==1%>
    ...
    <div style="background-color: #ffffff; color:red;">( 立即兑换后,请在后面再进行确认填写好地址！) </div>
