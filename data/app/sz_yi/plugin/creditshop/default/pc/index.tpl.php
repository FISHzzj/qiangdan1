...
<style type="text/css">
  ...
  .jf-tit .tx-list{ background: #f5fbef;color: #323333;border: 1px solid #bfd6af;font-size: 12px;padding: 4px}
    ...
    .list .good .info .span1{background: #e31939;}
    .top01 .left .info .price,.top01 .right .good .info .price,.list .good .info .price{color: #e31939;}
    .list .good .info .img img{min-height: 0px;}
</style>
