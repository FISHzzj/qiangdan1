...
<div class="order_menu">
        ...
        <div class="nav"  data-status='0'>待发款</div>
        <div class="nav"  data-status='1'>已发款</div>
...
function bindScroller(){
        ...
        $(window).scroll(function () {
            ...
            if ($(document).height() <= totalheight) {
                ...
                if (stop == true) {
                    ...
                    page++; 
                    core.pjson('premium/order', {status:current_status,page: page}, function (morejson) {
                        stop = true;
        ...
        function getOrder(status) {
            ...
            core.pjson('premium/order', {status:status, page: page}, function (json) {
