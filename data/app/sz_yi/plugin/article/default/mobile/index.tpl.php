...
<script>
    $(function(){
        ...
        wx.ready(function () {
            ...
            wx.onMenuShareAppMessage({                title: "<?php  echo $_W['shopshare']['title'];?>",          	    desc: "<?php  echo $_W['shopshare']['desc'];?>",          	    link: "<?php  echo $_W['shopshare']['link'];?>",          	    imgUrl: "<?php  echo $_W['shopshare']['imgUrl'];?>",            	success:function(res){            		$.ajax({            			type:'post',            			url:"<?php  echo $this->createPluginMobileUrl('article',array('aid'=>$article['id']))?>",            			success:function(data){            				if(data == 1){            					console.log("分享成功");            				}            			}            		});            	}            });
