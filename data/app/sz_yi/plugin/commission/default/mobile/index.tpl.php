...
<script id='tpl_main' type='text/html'>
    ...
    <ul class="clearfloat hs-commission">
        ...
        <!-- <li>
            ...
            <span class="hs-money"><a href="<?php  echo $this->createPluginMobileUrl('commission/withdraw')?>" class="take">佣金明细</a></span>
        ...
        <!-- <li>
            ...
            <a href="<?php  echo $this->createPluginMobileUrl('commission/withdraw')?>">
                ...
                <span class="hs-list"><?php  echo $this->set['texts']['commission1']?><br><span><%member.commission_ok%></span>元</span>
    ...
    <li>
            ...
            <a href="<?php  echo $this->createMobileUrl('member/bonuslog')?>">
                ...
                <span class="hs-list"><?php  echo $this->set['texts']['commission_detail']?><br><span>提现明细</span></span>
