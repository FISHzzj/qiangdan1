...
.order_menu .navon {color:#00c1ff; border-bottom:2px solid #00c1ff;}
...
<script id='tpl_empty' type='text/html'>
    <div style="padding-top:120px;width:190px;margin:0 auto;">
        ...
        <span style="width: 100px;background:#FF3E3E;padding:5px 21px;color:#fff;border-radius:4px;margin: 0 auto;display: block;"  onclick="location.href='<?php  echo $this->getUrl()?>'">随便逛逛</span>
    </div>
</script>
