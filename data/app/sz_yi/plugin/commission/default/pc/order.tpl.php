...
.order_menu .nav {height:44px; width:18%; border-bottom:1px solid #f1f1f1;background:#fff; border-left:1px solid #f1f1f1; float:left; line-height:44px; font-size:14px; color:#666; text-align:center;}
...
<div style="background: #eee;width: 960px;float: left;background: #fff;padding: 0;margin-left: 15px;">
     <div class="order_top">
        <div class="title" onclick='history.back()'>
            <?php  echo $this->set['texts']['order']?>(<?php  echo $ordercount;?>)
        </div>
...
<div id='container' class="rightlist" style="background: #eee;float: left;margin-left: 15px;"></div>
