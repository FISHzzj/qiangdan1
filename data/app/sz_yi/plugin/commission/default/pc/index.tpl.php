...
.top-fx .top_2 .pr-jine em{font-size:40px; line-height:66px; color:#e31939;float: left;font-style: normal;}
...
<script id='tpl_main' type='text/html'>
    ...
    <div class="menu2">  
        ...
        <a href="<?php  echo $this->createPluginMobileUrl('commission/rank')?>"><div class="nav nav2"><i class="fa fa-user  fa-3x" style="color:#53bdec;"></i><div class="title"><?php  echo $this->set['texts']['rank']?></div><div class="con">级别详细</div></div></a>
        ...
        <a href="#"><div class="nav nav1"><i class="fa fa-times fa-3x" style="color:#ff9901;"></i><div class="title">订单总计</div><div class="con"><span><%pricecount%></span> 元</div></div></a>
    </div>
</script>
