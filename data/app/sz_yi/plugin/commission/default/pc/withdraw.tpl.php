...
.gold_top {height:168px; width:100%; background:#fcfbf7; padding:30px 3% 0px;border-top: 3px solid #e31939;border-bottom: 1px #eee solid;}
.gold_top .title {    line-height: 12px;font-size: 12px;color: #a9a9a9;}
.gold_top .num {width: 100%;overflow: hidden;}
.gold_top .num em{font-size: 40px;line-height: 66px;color: #e31939;float: left;font-style: normal;}
...
.gold_num .nav .num {height:20px; width:100%; color:#e31939; font-size:20px; line-height:16px;}
