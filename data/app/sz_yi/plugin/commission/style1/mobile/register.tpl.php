...
<script id='tpl_main' type='text/html'>
  <div class="top">
        <img src="<%if set.regbg!=''%><%set.regbg%><%else%>../attachment/images/2/2016/09/MK7ak6akESn64N4Q44nhxeehe4hNnH.jpg
<%/if%>" />
  </div>
...
<script id="tpl_ok" type="text/html">
     <div class="top">
        <img src="<%if set.regbg!=''%><%set.regbg%><%else%>../addons/sz_yi/plugin/commission/template/mobile/style1/static/images/fenxiao_ico5.jpg<%/if%>" />
     </div>
    <div class="ok">
