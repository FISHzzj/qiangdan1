...
.bottom {width:100%; background:#fff; padding:10px; border-top:1px solid #eee; position:fixed; bottom:0px; left:0px; box-shadow:1px 2px 10px rgba(0,0,0,0.2);}
...
.hs-sub{position: fixed;right: 0;width: 50px;height: 50px;border-radius: 50%;box-shadow: 0 0 0 1px #ddd;border: 1px solid #fff}
</style> 
 <?php  if(!empty($goods)) { ?>
<!--<div class="top">
    ...
    <!-- 底部浮层 开始 -->
        ...
        <div id="btn1" class="hs-sub" style="top:40%;background:#e2454a url(../addons/sz_yi/plugin/commission/template/mobile/style1/static/images/sub01.png) 0 0 no-repeat;background-size:100%"></div>
        <div id="btn2" class="hs-sub" style="top:50%;background:#00b7ee url(../addons/sz_yi/plugin/commission/template/mobile/style1/static/images/sub02.png) 0 0 no-repeat;background-size:100%"></div>
        <?php  } else { ?>
