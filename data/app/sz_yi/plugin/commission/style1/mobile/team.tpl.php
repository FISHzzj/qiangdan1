...
<style type="text/css">
    ...
    .team_list_head { height: 46px; width: 100%; background: #fff; padding: 13px 3% 10px 3%; border-bottom: 1px solid #eaeaea; }
    ...
    .team_list_head .num2 { height: 20px; float: right; text-align: right; font-size: 16px; color: #666; line-height: 20px; font-size: 14px; color: #989898; }
    .team_list { height: 70px; width: 100%;padding: 15px 3%;background: white;border-bottom: 1px solid #eaeaea; }
    .team_list .img { width: 16%; height: 40px; float: left; text-align: left; }
    .team_list .img img { height: 40px; width: 40px; }
    .team_list .info { height: 40px; width: 40%; float: left; font-size: 16px; color: #666; line-height: 20px; text-align: left; }
    .liuyan { height: 40px; width: 63px; float: left; text-align: center; line-height: 20px; font-size: 15px; color: #656565 ; }
    .team_list .info span { font-size: 14px; color: #989898; }
    .team_list .num2 { height: 40px; width: 23%; float: right; text-align: right; font-size: 16px; color: #666; line-height: 20px; }
    .team_list .num2 span { font-size: 14px; color: #989898; }
    ...
    .team_navon { color: #fff; background: #e45050; }
    ...
    .liuyanImg{position: absolute;left:-7px;bottom: 0px;width: 20px;}
    @media screen and (max-width: 320px){
    	.liuyanImg{position: absolute;left:50px;bottom: 0px;width: 20px;}
    }
</style>
...
.diseaseMenu {height:41px;line-height:40px;width: 100%;}
.menuScroll1_lists {height:40px;width:720px;border-bottom: 1px solid #e45050;}
...
<div class="page_topbar">
	<a href="#" class="back" onclick='history.go(-1)'><i class="fa fa-angle-left"></i></a>
	<div class="title"><?php  echo $this->set['texts']['myteam']?>(<?php  echo $total;?>)</div>
</div>
<?php  if($total>0) { ?>
...
<div class="team_list_head">
        ...
        <div class="num2">TA的<?php  echo $this->set['texts']['commission']?>/成员</div>
</div>
...
<script id='tpl_team' type='text/html'>
    ...
    <div class="team_list">
		...
		<a href="<?php  echo $this->createPluginMobileUrl('commission/team',array('op'=>'liuyan','sender'=>'superior'))?>&id=<%user.id%>">
			<div class="liuyan f-relative">
				<span>给Ta</br>留言</span>
				<img src="../addons/sz_yi/plugin/commission/template/mobile/style1/static/images/liuyan.png" class="liuyanImg">
			</div>

		</a>
		<?php  } ?>
        <div class="num2">+<%user.commission_total%><br><span><%user.agentcount%> 个成员</span></div>
        <div class="f-cb"></div>
    </div>
    <%/each%>
</script>
