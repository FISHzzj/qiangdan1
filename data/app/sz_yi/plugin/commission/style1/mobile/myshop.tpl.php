<?php defined('IN_IA') or exit('Access Denied');?><!-- 222 -->
...
.top .bgimg .shopimg {height:70px; width:70px; position:absolute; left: 5px;bottom: 10px;z-index: 105}
.top .bgimg .shopimg img {height:70px; width:70px;}
.top .bgimg .shopname {height:40px; width:auto; position:absolute; left:80px; bottom:50px;  line-height:40px; font-size:14px; color:#fff; text-shadow:2px 2px 2px rgba(0,0,0,0.2);}
...
.top .nav .sub nav {font-size:12px; color:#999;}
    ...
    .goods .good {overflow:hidden; width:50%; padding:10px 2% 10px; float:left;}
...
.activex a{ color: #ff1c1d!important; border-bottom: 2px #ff1c1d solid; }
  ...
  .banner .main_image li a{display:block;width:100%;}
    ...
    /* 新 */
.wrap{height: 80px;background: rgba(0, 0, 0, 0.50);position: absolute;bottom: 0px;width: 100%;}
.erweima{position: absolute;right: 15px;top:15px;font-size: 12px;color: white;}
.f-colorwhite{color: white;}
.notice{width: 75px;height: 23px;border-radius: 15px;color: white;line-height: 20px;text-align: center;font-size: 13px;border:2px solid  #fc8b21;position: absolute;right: 10px;bottom: 15px;}
</style>
   ...
   <div class="bgimg">
       ...
       <!--  <img src="../addons/sz_yi/static/images/1.jpg"> -->
        <div class="">
            ...
            <!-- <div style="height:40px; width:auto; position:absolute; left:80px; bottom:6px; font-size:14px; line-height:49px; font-size:14px; color:#fff; ">
                     销量：<%to ? to : 0%>
            </div>
            <div class="erweima" id="QR" onclick="location.href='<?php  echo $this->createPluginMobileUrl('commission/shares')?>'">
