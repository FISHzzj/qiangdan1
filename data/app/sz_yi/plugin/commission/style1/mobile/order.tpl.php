...
.order_top .num { float:right;color:#656565;height:44px;line-height:44px;padding-right:5px;}
    
.order_menu {height:44px; background:#fff;}
.order_menu .nav {height:44px; width:25%; border-bottom:1px solid #f1f1f1;background:#fff; float:left; line-height:44px; font-size:14px; color:#666; text-align:center;}
.order_menu .navon {color:#e45050; border-bottom:2px solid #e45050;border-right: 0;}
...
.order_detail {overflow:hidden; padding:10px; background:#fff; border-top:1px solid #eaeaea;}
   .team_list {height:40px; background:#fff; }
    ...
    .headerRightIcon {width: 25px;height: 25px;position: absolute;right: 10px;top: 0px;}
</style>
<!-- <div class="order_top">
...
<div class="page_topbar" ">
    ...
    <div class="title" style=" color: #282828;"><?php  echo $this->set['texts']['order']?>(<?php  echo $ordercount;?>)</div>
  <a href="#">
...
<script id='tpl_empty' type='text/html'>
    <div style="padding-top:120px;width:190px;margin:0 auto;">
        <img style="width:60px;display:block;margin:0 auto;" src="../addons/sz_yi/plugin/commission/template/mobile/default/static/images/order.png" alt="">
        <span style="display:block;margin-top: 18px; text-align:center;">您还没有相关<?php  echo $this->set['texts']['order']?>~</span></br>
        <span style="width: 100px;background:#e45050;padding:5px 21px;color:#fff;border-radius:5px;margin: 0 auto;display: block;"  onclick="location.href='<?php  echo $this->getUrl()?>'">随便逛逛</span>
    </div>
</script>
