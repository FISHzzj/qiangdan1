...
.order_menu .navon {height:42px; color:#e31939; border-bottom:2px solid #e31939;}
...
<div style="width: 960px;float: left;margin-left: 15px;">
    ...
    <div class="order_top">
        ...
        <div class='num'>预计: +<?php  echo $member['commission_total'];?>元</div>

    </div>

    <div class="order_menu">

            <div class="nav navon" style="border-left:0px;width:16%;" data-status=''>所有订单</div>
		...
		<div class='detail_good'>
			...
			<%each order.order_goods as g%>
				...
				<div class="price">
					...
					<div class='pnum'>预计金额:<span style="color:#666;">+<%g.commission%></span></div>

				</div><br/>

                <div class="leiji" style="width:110px;float:right;margin-right:-60px;">

                    <div class='pnum'>累计:<%g.mcount%></div>

                </div><br/>

                <div class="fanxian" style="width:110px;float:right;margin-right:-10px;">

                    <div class='pnum'>已返现:<%g.fcount%>/<%g.qishu%></div>
