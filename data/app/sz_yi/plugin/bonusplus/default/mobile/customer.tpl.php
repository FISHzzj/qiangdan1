...
<style type="text/css">
    ...
    .customer_list_head {height:40px; width:100%; background:#fff; padding:10px 3%;border-bottom:1px solid #eaeaea;}
    ...
    .customer_list_head .num2 {height:20px; float:right; text-align:right; font-size:16px; color:#666; line-height:20px; font-size:14px; color:#999;}





    .customer_list {overflow:hidden; width:100%; background:#fff; padding:10px 3%;}
    ...
    .customer_list .num2 {height:40px; width:23%; float:right; text-align:right; font-size:16px; color:#666; line-height:20px;}

    .customer_list .num2 span {font-size:14px; color:#999;}
...
<div class="customer_top">
    ...
    <div class="title" onclick='history.back()'><i class='fa fa-chevron-left'></i> <?php  echo $this->set['texts']['mycustomer']?>(<?php  echo $member['customercount1'];?>)</div>
...
<script id='tpl_customer' type='text/html'>
    ...
    <div class="customer_list">
        ...
        <div class="num2"><%user.ordercount%> 订单<br><span><%user.moneycount%> 元</span></div>
...
function bindScroller(){
        ...
        $(window).scroll(function () {
            ...
            if ($(document).height() <= totalheight) {
                ...
                if (stop == true) {
                    ...
                    core.pjson('bonusplus/customer', {page: page}, function (morejson) {
        ...
        function getcustomer() {
            ...
            core.pjson('bonusplus/customer', {page: page}, function (json) {
