...
.order_menu {height:44px;}
.order_menu .nav {height:44px; width:20%; border-bottom:1px solid #f1f1f1;background:#fff; border-left:1px solid #f1f1f1; float:left; line-height:44px; font-size:14px; color:#666; text-align:center;}
.order_menu .navon {height:42px; color:#e45050; border-bottom:2px solid #e45050;}
...
.order_list .right span {color:#e45050;}
...
<div class="order_top">
    ...
    <div class='num2'>预计: +<?php  echo $member['commission_total'];?>元</div>
</div>
<div class="order_menu">
        <div class="nav navon" style="border-left:0px;width:20%;" data-status=''>所有订单</div>
        <div class="nav"  data-status='4'>待付款</div>
        <div class="nav"  data-status='1'>已付款</div>
        <div class="nav"  data-status='2'>待收货</div>
	...
	<div class="order_detail" style='display:none;'>
		...
		<div class='detail_good'>
			<%each order.order_goods as g%>
				...
				<div class="price">
					<div class='pnum'>预计金额</div>
					<div class='num'>+<%g.commission%></div>
				</div>
                <div class="leiji">
                    <div class='pnum'>累计:</div>
                    <div class='num'>
                    <if><%g.mcount%></if>
                    </div>
                </div>
                <div class="fanxian">
                    <div class='pnum'>已返现:</div>
                    <div class='num'><%g.fcount%>/<%g.qishu%></div>
...
<script id='tpl_empty' type='text/html'>
    <div style="padding-top: 45px; width: 190px; margin: 0 auto;width: 80%;height: 180px;margin: 120px auto 0 auto;background: #fff">
    	<img style="width:60px;display:block;margin:0 auto;" src="../addons/sz_yi/plugin/suppliermenu/template/mobile/default/images/order.png" alt="">
...
function bindScroller(){
        ...
        $(window).scroll(function () {
            ...
            if ($(document).height() <= totalheight) {
                ...
                if (stop == true) {
                    ...
                    page++; 
                    core.pjson('bonusplus/order', {status:current_status,page: page}, function (morejson) {
                        stop = true;
        ...
        function getOrder(status) {
            ...
            core.pjson('bonusplus/order', {status:status, page: page}, function (json) {
