...
<div class="order_top">
    ...
    <div class='num'>总分红金额: <span style="color:red;"><?php  echo $total;?></span></div>
</div>
...
<script id='tpl_order' type='text/html'>
  ...
  <div class="order_list">
   ...
   <div class="right"><span style="color:#999;"><span style="color:red;">+<%order.money%>元</span></span></div>
 </div>
    <%/each%>
</script>
...
function bindScroller(){
        ...
        $(window).scroll(function () {
            ...
            if ($(document).height() <= totalheight) {
                ...
                if (stop == true) {
                    ...
                    page++; 
                    core.pjson('bonusplus/detail', {status:current_status,page: page}, function (morejson) {
                        stop = true;
        ...
        function getOrder(status) {
            ...
            core.pjson('bonusplus/detail', {status:status, id:<?php  echo $_GPC['id'];?>, page: page}, function (json) {
