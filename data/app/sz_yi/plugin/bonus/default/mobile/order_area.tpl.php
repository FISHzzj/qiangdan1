...
.order_menu .navon {height:44px; color:#e45050; border-bottom:2px solid #e45050;}
...
<div class="order_top" style="background: #fff;">
    <div class="title" onclick='history.back()'><i class="iconfont arrow" style="color: #282828;">&#xe618;</i>  <?php  echo $this->set['texts']['order_area']?>(<?php  echo $ordercount;?>)</div>
...
<script id='tpl_empty' type='text/html'>
   ...
   <!-- <div style="padding:10px 0 10px 0;width:80%;background:#fff;margin:120px auto 0 auto;height: 180px;">
        <img style="width:60px;display:block;margin:20px auto 0 auto;" src="../addons/sz_yi/plugin/suppliermenu/template/mobile/default/images/Detailed.png" alt="">
     ...
     <div style="padding:10px 0 10px 0;width:80%;margin:120px auto 0 auto;height: 180px;">
        <img style="width:60px;display:block;margin:10px auto 0 auto;" src="../addons/sz_yi/plugin/suppliermenu/template/mobile/default/images/Detailed.png" alt="">
