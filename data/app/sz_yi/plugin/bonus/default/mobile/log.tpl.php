...
<div class="log_top" style="background: #fff;">
       <div class="title" onclick='history.back()'  ><i class="iconfont arrow" style="color: #282828;">&#xe618;</i> <?php  echo $this->set['texts']['commission_detail']?>(<span id='total'></span>)</div>
...
<script id='tpl_empty' type='text/html'>
   <!--  <div style="padding-top:120px;width:190px;margin:0 auto;">
    ...
    <div style="padding:10px 0 10px 0;width:80%;margin:120px auto 0 auto;height: 180px;">
        <img style="width:60px;display:block;margin:10px auto 0 auto;" src="../addons/sz_yi/plugin/suppliermenu/template/mobile/default/images/fhmx.png" alt="">
