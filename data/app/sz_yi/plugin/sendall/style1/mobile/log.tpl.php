...
<script id='tpl_log' type='text/html'>
  ...
  <div class="log_list"
   ...
   <!--<%log.commission%> <div class="right"><br><span><%log.status str%></span></div> -->
...
function bindScroller(){
        ...
        $(window).scroll(function () {
            ...
            if ($(document).height() <= totalheight) {
                ...
                if (stop == true) {
                    ...
                    page++;
                    core.pjson('sendall/log', {status:current_status,page: page}, function (morejson) {
                        stop = true;
                        $('#log_loading').remove();
        ...
        function getLog(status) {
            ...
            core.pjson('sendall/log', {status:status, page: page}, function (json) {
               ...
               $('#commissioncount').html( json.result.commissioncount);
                ...
                $('#container').html(tpl('tpl_log', json.result));
                 $('.log_list').unbind('click').click(function(){
                    ...
                    var url = core.getUrl('plugin/sendall/log',{'op':'detail','id':applyid});
                    //location.href = url;
                    return;
                 });
