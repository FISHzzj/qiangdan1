...
<div id='container' style="overflow: hidden;">
    ...
    <ul class="clearfloat hs-commission">
        <!-- 佣金 -->
        <!-- <li>
            <a href="<?php  echo $this->createPluginMobileUrl('sendall/withdraw')?>">
        ...
        <!-- 分红订单 -->
<!--         <li>
            <a href="<?php  echo $this->createPluginMobileUrl('sendall/order')?>">
        ...
        <!-- 分红明细 -->
        <li>
            <a href="<?php  echo $this->createPluginMobileUrl('sendall/log')?>">
        ...
        <!-- 我的下线 -->
        <li>
            <a href="<?php  echo $this->createPluginMobileUrl('sendall/customer')?>">
        ...
        <li>
            <a href="<?php  echo $this->createPluginMobileUrl('sendall/order_area')?>">
