...
<div class="order_top">
 ...
 <div class="left"><div class='inner'><span>流水号：<?php  echo $vo['ordersn'];?></br><?php  echo $vo['createtime'];?></span></div></div>
   <div class="right"><span style="color:#999;"><span style="color:red;">￥<?php  echo $vo['money'];?></span></br></br><?php  if($vo['status']==1) { ?>已申请<?php  } ?></div>
 </div>
    <?php  } } ?>
