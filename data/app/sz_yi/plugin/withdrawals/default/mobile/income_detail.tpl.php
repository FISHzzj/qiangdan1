...
<style type="text/css">
	...
	.content-list .leftlist span{display: block;font-size: 15px;margin-top: 5px;}
	.content-list .rightlist{width:30%;text-align: right;}
	.content-list .rightlist span{display: block;font-size: 16px;margin-top: 8px;}
</style>
<body>
