...
.order_sub_qr {height: 44px;
    margin: 14px 5px;
    background: hsl(106, 100%, 40%);
    border-radius: 4px;
    text-align: center;
    font-size: 16px;
    line-height: 44px;
...
<script id='tpl_order_info' type='text/html'>
    ...
    <div id="qrcode" class="hide" style="margin:0 auto; text-align:center">
    <img src="" id="wechat_code" />
    </div>
...
//                         var deduct = ($('#deductmoney').length>0 &&$('#deductmoney').attr('on')=='1' )?1:0 ;
//                         core.json('order/pay', {op: 'pay' , type: 'weixin' ,qr:1 ,orderid:'<?php  echo $_GPC['orderid'];?>',deduct:deduct}, function (rjson) {
