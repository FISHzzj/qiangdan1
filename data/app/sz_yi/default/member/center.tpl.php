...
<!--  <div class="cart" style='margin-top:-20px;'>
    <a href="javascript:;"><div class="list1" style=" border-bottom:0px;border-top:0px;">余额: <span style='color:#e31939'><%member.credit2%></span>
   ...
   <a href="javascript:;"><div class="list1" style="margin:-2px 0px 0; border-bottom:0px;">积分: <%member.credit1%>
    ...
    <a href="<?php  echo $this->createMobileUrl('member/indexCenter')?>">
        <div class="list1"><img src="../addons/sz_yi/template/pc/default/static/images/iconc1.png" alt="">引导页</div>
    </a>
    <div class="order">
        <a href="#">
            <div class="list1" style="margin-top:0px;">
                <img src="../addons/sz_yi/template/pc/default/static/images/iconc2.png" alt="">
                <span style="">会员中心</span>
            </div>
        </a>
        <div class="order_all">
            <a href="<?php  echo $this->createMobileUrl('member/info')?>">
                <div class="order_pub order_1" style="border:0px;">我的资料
...
<div class="order">
    <a href="<?php  echo $this->createMobileUrl('order')?>">
        <div class="list1" style="margin-top:0px;">
            ...
            <span style="">全部订单</span>
        </div>
    </a>
    <div class="order_all">
        <a href="<?php  echo $this->createMobileUrl('order',array('status'=>0))?>">
            <div class="order_pub order_1" style="border:0px;">待付款<%if order.status0>0%><span><%order.status0%></span><%/if%>
            <i class="fa fa-angle-right" style="color:#999; font-size:20px; float:right; line-height:25px;margin-right: 25px;"></i>
            </div>
        </a>
        <a href="<?php  echo $this->createMobileUrl('order',array('status'=>1))?>">
            <div class="order_pub order_2">待发货<%if order.status1>0%><span><%order.status1%></span><%/if%>
            <i class="fa fa-angle-right" style="color:#999; font-size:20px; float:right; line-height:25px;margin-right: 25px;"></i>
            </div>
        </a>
        <a href="<?php  echo $this->createMobileUrl('order',array('status'=>2))?>">
            <div class="order_pub order_3">待收货<%if order.status2>0%><span><%order.status2%></span><%/if%>
            <i class="fa fa-angle-right" style="color:#999; font-size:20px; float:right; line-height:25px;margin-right: 25px;"></i>
            </div>
        </a>
        <a href="<?php  echo $this->createMobileUrl('order',array('status'=>4))?>">
            <div class="order_pub order_4">待退款<%if order.status4>0%><span><%order.status4%></span><%/if%>
            <i class="fa fa-angle-right" style="color:#999; font-size:20px; float:right; line-height:25px;margin-right: 25px;"></i>
            </div>
        </a>
    </div>
...
<div class="order">
        ...
        <div class="order_all">
            ...
            <a href="<?php  echo $this->createPluginMobileUrl('bonusplus/index')?>">
                <div class="order_pub order_1" style="border:0px;"><?php echo empty($set['texts']['start']) ? "静态分红" : $set['texts']['start'];?>
                <i class="fa fa-angle-right" style="color:#999; font-size:20px; float:right; line-height:25px;margin-right: 25px;"></i>
                </div>
            </a>
            <?php  } ?>
            <a href="<?php  echo $this->createMobileUrl('member/points_log')?>">
                <div class="order_pub order_1" style="border:0px;">积分中心
                <i class="fa fa-angle-right" style="color:#999; font-size:20px; float:right; line-height:25px;margin-right: 25px;"></i>
                </div>
            </a>
            <?php  if(p('return')) { ?>
            <a href="<?php  echo $this->createPluginMobileUrl('return/return_log')?>">
                <div class="order_pub order_1" style="border:0px;">全返明细
                <i class="fa fa-angle-right" style="color:#999; font-size:20px; float:right; line-height:25px;margin-right: 25px;"></i>
                </div>
            </a>
            <?php  } ?>
            <a href="<?php  echo $this->createPluginMobileUrl('withdrawals/cash_withdrawal')?>">
                <div class="order_pub order_1" style="border:0px;">奖金提现
                <i class="fa fa-angle-right" style="color:#999; font-size:20px; float:right; line-height:25px;margin-right: 25px;"></i>
                </div>
            </a>
            <%if trade.withdraw==1%>
            <a href="javascript:;" id="btnwithdraw">
                <div class="order_pub order_1" style="border:0px;">余额提现
                <i class="fa fa-angle-right" style="color:#999; font-size:20px; float:right; line-height:25px;margin-right: 25px;"></i>
                </div>
            </a>
            <%/if%>
            ...
            <a href="<?php  echo $this->createMobileUrl('member/log')?>">
                <div class="order_pub order_1" style="border:0px;"><%if trade.withdraw==1%>余额明细<%else%>充值记录<%/if%>
                <i class="fa fa-angle-right" style="color:#999; font-size:20px; float:right; line-height:25px;margin-right: 25px;"></i>
                </div>
            </a>
             <%/if%>
            ...
            <%if shopset.hascoupon%>
                <a href="<?php  echo $this->createPluginMobileUrl('coupon/my')?>">
                    <div class="order_pub order_1" style="border:0px;">我的优惠券
                    <i class="fa fa-angle-right" style="color:#999; font-size:20px; float:right; line-height:25px;margin-right: 25px;"></i>
                    </div>
                </a>
                <%if shopset.hascouponcenter%>
                <a href="<?php  echo $this->createPluginMobileUrl('coupon')?>">
                    <div class="order_pub order_1" style="border:0px;">领取优惠券
            ...
            <%/if%>
             <a href="<?php  echo $this->createPluginMobileUrl('bonus')?>">
                <div class="order_pub order_1" style="border:0px;">分红中心
                <i class="fa fa-angle-right" style="color:#999; font-size:20px; float:right; line-height:25px;margin-right: 25px;"></i>
                </div>
            </a>
        </div>
    ...
    <div class="order">
            ...
            <?php  } ?>
                <a href="<?php  echo $this->createMobileUrl('member/notice')?>">
                    <div class="order_pub order_1" style="border:0px;">消息提醒设置
                    <i class="fa fa-angle-right" style="color:#999; font-size:20px; float:right; line-height:25px;margin-right: 25px;"></i>
                    </div>
                </a>
                <a href="<?php  echo $this->createMobileUrl('member/referral')?>">
                    <div class="order_pub order_1" style="border:0px;">我的分享链接
                    <i class="fa fa-angle-right" style="color:#999; font-size:20px; float:right; line-height:25px;margin-right: 25px;"></i>
                    </div>
                </a>
                <!-- <a href="<?php  echo $this->createMobileUrl('member/referral')?>">
                ...
                <a href="<?php  echo $this->createMobileUrl('shop/address')?>">
                    <div class="order_pub order_1" style="border:0px;">收货地址管理
                    <i class="fa fa-angle-right" style="color:#999; font-size:20px; float:right; line-height:25px;margin-right: 25px;"></i>
                    </div>
                </a>
...
<!-- <div class="cart">
    ...
    <a href="<?php  echo $this->createPluginMobileUrl('premium')?>"><div class="list1" ><i class="fa fa-home"></i>新三级分销<i class="fa fa-angle-right" style="color:#999; font-size:26px; float:right; line-height:44px;"></i></div></a>
   ...
   <?php  if(m('common')->getapplices()  == 0) { ?>
      <a href="<?php  echo $this->createMobileUrl('member/shangapplice')?>"><div class="list1" ><i class="fa fa-user"></i>商家申请<i class="fa fa-angle-right" style="color:#999; font-size:26px; float:right; line-height:44px;"></i></div></a>
   <?php  } ?>

    <a href="<?php  echo $this->createMobileUrl('member/shangapplice')?>"><div class="list1" ><i class="fa fa-user"></i>商家申请<i class="fa fa-angle-right" style="color:#999; font-size:26px; float:right; line-height:44px;"></i></div></a>


    <a href="<?php  echo $this->createMobileUrl('member/shangguan')?>"><div class="list1" ><i class="fa fa-user"></i>商家关注<i class="fa fa-angle-right" style="color:#999; font-size:26px; float:right; line-height:44px;"></i></div></a>
...
<div class="cart">
    ...
    <?php  if(('bonusplus')) { ?>
        <a href="<?php  echo $this->createPluginMobileUrl('bonusplus/index')?>"><div class="list1" style="margin:0px; border-bottom:0px;"><i class="fa fa-piechart" style="color:#f10;"></i><?php echo empty($set['texts']['start']) ? "静态分红" : $set['texts']['start'];?><i class="fa fa-angle-right" style="color:#999; font-size:26px; float:right; line-height:44px;"></i></div></a>
    <?php  } ?>

    <a href="<?php  echo $this->createPluginMobileUrl('withdrawals/cash_withdrawal')?>"><div class="list1" style="margin:0px; border-bottom:0px;"><i class="fa fa-piechart" style="color:#f10;"></i>奖金提现<i class="fa fa-angle-right" style="color:#999; font-size:26px; float:right; line-height:44px;"></i></div></a>
</div>
    <?php  if(p('article')) { ?>
...
<div class="cart">
    ...
    <%/if%>
    <a href="<?php  echo $this->createMobileUrl('member/points_log')?>"><div class="list1"><i class="fa fa-street-view"></i>积分记录<i class="fa fa-angle-right" style="color:#999; font-size:26px; float:right; line-height:44px;"></i></div></a>
