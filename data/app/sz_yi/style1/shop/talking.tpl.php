	...
	<div class="artc-box" style="margin-top: 50px;"> 
			...
			<div class="a-aricle">
				...
				<div class="f-relative My" > 
					<img src="<?php  echo $row['member_img'];?>" class="face faceMy">
					<p class="name f-tar"><?php  echo $row['member_name'];?></p>
				...
				<div class="f-relative Your" >					
					<img src="../attachment/<?php  echo $row['logo'];?>" class="face faceYour">
					<p style="margin-bottom:5px;" class="name f-tal"><?php  echo $row['uid_name'];?></p>
					<div style="margin-bottom:5px;" class="neirong f-tal fl f-relative">
  ...
  $(function(){
	  window.onload = function(){
	    ...
	    setInterval(function(){
	      $.ajax({
	        url : "<?php  echo $this->createMobileUrl('shop/talking')?>",
	        type :'post',
	        data : {'op':'liuyan','id':'<?php  echo $superior_id;?>'},
	        dataType : 'json',
	        success : function(data){        	
	              if(data.status){
	              	$('.artc-box').html("");
    ...
    $('#arearecord').click(function(){
      ...
      $.ajax({
        url : "<?php  echo $this->createMobileUrl('shop/talking')?>",
        type :'post',
        data : {'content':contentss,'op':'send','id':'<?php  echo $superior_id;?>'},
        dataType : 'json',
        success : function(data){
