<?php defined('IN_IA') or exit('Access Denied');?><?php (!empty($this) && $this instanceof WeModuleSite || 0) ? (include $this->template('common/header', TEMPLATE_INCLUDEPATH)) : (include template('common/header', TEMPLATE_INCLUDEPATH));?>
	<style>
		...
		.table-row2-th{width: 50%;}
	</style>
<div class="we7-page-title">公众号管理</div>
<ul class="we7-page-tab">
	<li class="active"><a href="<?php  echo url('account/manage');?>">商城列表</a></li>
...
<!--<div class="alert alert-success alert-dismissable">-->
            <!--&lt;!&ndash;<button type="button" class="close" data-dismiss="alert" aria-hidden="true"></button><i class="fa fa-bullhorn alert-link">&ndash;&gt;-->
        <!--&lt;!&ndash;</i> 开通的不同版本可以使用不同的权限 <a href="./index.php?c=website&a=taocan-show" target="_blank" style="border-radius: 4px;width: 84%;padding: 4px;font-size: 14px;background-color: #00bc0c;border-color: #00bc0c;color: #FFF">套餐价格、包含应用套餐表</a>&ndash;&gt;-->
<!--</div>-->
...
<table class="table we7-table table-hover vertical-middle table-manage" id="js-system-account-display" ng-controller="SystemAccountDisplay" ng-cloak>
	...
	<tr>
		<th colspan="2" class="text-left table-row2-th">帐号</th>
		<th>有效期</th>
	...
	<tr class="color-gray" ng-repeat="list in lists">
		...
		<td class="vertical-middle table-manage-td">
			...
			<div class="manage-option text-right">
				...
				<?php  if($_W['role'] != ACCOUNT_MANAGE_NAME_MANAGER && $_W["isfounder"]) { ?>
