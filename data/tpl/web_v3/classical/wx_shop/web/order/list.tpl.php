    ...
    <form action="./index.php" method="get" class="form-horizontal table-search" role="form"  id="search">
        ...
        <div class="page-toolbar">
            <div class="input-group">
                ...
                <span class="input-group-select">
                    <select name="is_submit" class="form-control" style="width:100px;padding:0 5px;">
                        <option value="" <?php  if($_GPC['is_submit']=='') { ?>selected<?php  } ?>>是否提交</option>
                        <option value="1" <?php  if($_GPC['is_submit']== 1) { ?>selected<?php  } ?>>已提交</option>
                        <option value="0" <?php  if($_GPC['is_submit']== 0) { ?>selected<?php  } ?>>未提交</option>
                    </select>
                </span>
                <span class="input-group-select">
                ...
                <span class="input-group-select">
                    <select name='freeze'  class='form-control'   style="width:100px;padding:0 5px;">
                        ...
                        <option value='0' <?php  if($_GPC['freeze']=='0') { ?>selected<?php  } ?>>未冻结</option>
                    </select>
                </span>
                <span class="input-group-select">
                    <select name='issue'  class='form-control'   style="width:100px;padding:0 5px;">
                        <option value=''>佣金发放</option>
                        <option value='1' <?php  if($_GPC['issue']=='1') { ?>selected<?php  } ?>>已发放</option>
                        <option value='0' <?php  if($_GPC['issue']=='0') { ?>selected<?php  } ?>>未发放</option>
                    </select>
                </span>
                ...
                <div class="tables">
                    ...
                    <div class='table-row' style="margin:0  20px">
                        <div class="goods-des" style='width:400px;text-align: left'>
                            ...
                            <div style="display: -webkit-box;display: -webkit-flex;display: -ms-flexbox;display: flex;margin: 10px 0">
                                <img src="<?php  echo tomedia($g['thumb'])?>" style='width:70px;height:70px;border:1px solid #efefef; padding:1px;'onerror="this.src='../addons/wx_shop/static/images/nopic.png'">
                    ...
                    "
                        ...
                        <div  class='ops list-inner' style='line-height:20px;text-align:center' >
                            <span class='text-<?php  echo $item['statuscss'];?>'><?php  if($item['freeze'] == 1) { ?><span style="color: red;">订单已冻结<?php  if($item['refund'] == 1) { ?><span style="color: navy;">(已退款)</span><?php  } ?></span><?php  } else { ?><?php  echo $item['status'];?><?php  } ?></span><?php  if($item['merchid'] == 0) { ?><?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('order/ops', TEMPLATE_INCLUDEPATH)) : (include template('order/ops', TEMPLATE_INCLUDEPATH));?><?php  } ?>
                            <?php  if($item['issue'] == 1) { ?><span style="color:orangered;">佣金已发放</span><?php  } else { ?><span style="color:silver;">佣金未发放</span><?php  } ?>
                        </div>
