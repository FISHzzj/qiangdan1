<?php defined('IN_IA') or exit('Access Denied');?><div class="form-group">
    ...
    <div class="col-sm-9 col-xs-12">
        <img class="radius50" src="<?php  echo $member['avatar'];?>" style='width:50px;height:50px;padding:1px;border:1px solid #ccc' onerror="this.src='../addons/wx_shop/static/images/noface.png'"/>
...
<!-- <div class="form-group">
    ...
    <div class="col-sm-9 col-xs-12">
        ...
        <div class='form-control-static'>
            ...
            <?php  } else { ?>
            <?php  echo pdo_fetchcolumn('select levelname from '.tablename('wx_shop_member_level').' where id=:id limit 1',array(':id'=>$member['level']))?>
            <?php  } ?>
        </div>
        <?php  } ?>
    </div>
...
<!-- <div class="form-group">
    ...
    <div class="col-sm-9 col-xs-12">
        ...
        <div class='form-control-static'>
            ...
            无分组
            <?php  } else { ?>
            <?php  echo pdo_fetchcolumn('select groupname from '.tablename('wx_shop_member_group').' where id=:id limit 1',array(':id'=>$member['groupid']))?>
            <?php  } ?>
        </div>
        <?php  } ?>
    </div>
...
<?php if(cv('member.list.edit')) { ?>
    <div class="form-group">
     ...
     <div class="form-group">
        <label class="col-lg control-label">支付密码</label>
        <div class="col-sm-9 col-xs-12">
            <?php  echo tpl_form_field_editor(array('name'=>'data[pwd2]', 'value'=>''))?>
            <div class="form-control-static">密码留空则不修改</div>
        </div>
    </div>
<?php  } ?>
