<?php defined('IN_IA') or exit('Access Denied');?><!-- <div class="form-group">
    ...
    <div class="col-sm-9 col-xs-12">
        ...
        <?php  } else { ?>
        <?php  echo pdo_fetchcolumn('select levelname from '.tablename('wx_shop_abonus_level').' where id=:id limit 1',array(':id'=>$member['aagentlevel']))?>
        <?php  } ?>
        <?php  } ?>
    </div>
</div> -->
               ...
               <!--  <div class="form-group"  >
                ...
                <div class="form-group"  >
                    ...
                    <div class="col-sm-9 col-xs-12">
                      ...
                      <span class="help-block text-danger">省级代理可代理任何地区, 市级代理只能代理城市</span>
                        </div>
                    </div>
            </div>
