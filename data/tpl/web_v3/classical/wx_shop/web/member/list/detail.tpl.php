	...
	<div class="tabs-container">
		...
		<div class="tabs">
			<ul class="nav nav-tabs">
				...
				<!--代理分红修改begin-->
				<?php  if($hasweightbonus) { ?>
				<li class=""><a data-toggle="tab" href="#tab-weightbonus" aria-expanded="false">代理信息</a></li>
				<?php  } ?>
				<!--代理分红修改end-->
			...
			<div class="tab-content ">
				...
				<!--代理分红修改begin-->
				<?php  if($hasweightbonus) { ?>
				<div id="tab-weightbonus" class="tab-pane"><?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('member/detail/weightbonus', TEMPLATE_INCLUDEPATH)) : (include template('member/detail/weightbonus', TEMPLATE_INCLUDEPATH));?></div>
				<?php  } ?>
				<!--代理分红修改end-->
