                ...
                <span class="input-group-select">
                    <select name='level' class='form-control'>
                        ...
                        <?php  if(is_array($levels)) { foreach($levels as $level) { ?>
                            <option value="<?php  echo $level['level'];?>" <?php  if($_GPC['level']==$level['level']) { ?>selected<?php  } ?>><?php  echo $level['levelname'];?></option>
                        <?php  } } ?>
                    </select>
                </span>
                    ...
                    <tbody>
                        ...
                        <?php  } ?> <br/>
                               <span>状态:</span>  <?php  if($row['isblack']==1) { ?>黑名单<?php  } else { ?>正常<?php  } ?> ">
                                   ...
                                   <img class="img-40" src="<?php  echo tomedia($row['avatar'])?>" style='border-radius:50%;border:1px solid #efefef;' onerror="this.src='../addons/wx_shop/static/images/noface.png'" />
                           ...
                           <!--      <br/><?php  if(empty($row['groupname'])) { ?>无分组<?php  } else { ?><?php  echo $row['groupname'];?><?php  } ?>
                            ...
                            <td><span ><!-- 积分:  <span style="color: #5097d3"><?php  echo intval($row['credit1'])?></span> --> </span>
                                <br/><span>余额: <span class="text-warning"><?php  echo price_format($row['credit2'],2)?> </span> <br/><span><!-- 可提现佣金: <span style="color:red"><?php  echo price_format($row['credit_commission'],2)?> </span></span> --></td>
                            <!-- <td><?php  echo price_format($row['credit3'],2)?></td> -->
