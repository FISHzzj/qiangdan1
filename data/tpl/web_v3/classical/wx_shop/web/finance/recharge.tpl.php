            ...
            <div class="modal-body">
                ...
                <div class="recharge_info">
                    <div>
                        ...
                        <div class="pull-left">
                            <img class="radius50" src='<?php  echo $profile['avatar'];?>' style='width:20px;height:20px;padding:1px;border:1px solid #ccc' onerror="this.src='../addons/wx_shop/static/images/noface.png'"/>
                    ...
                    <div>
                        <label class="pull-left " style="margin-right: 25px">会员信息</label>
                            <div class="pull-left">
                                ...
                                手机号: <?php  echo $profile['mobile'];?></br>
                                余额: <?php  echo $profile['credit2'];?></br>
                                <!-- 押金: <?php  echo $profile['credit3'];?> -->
                            </div>
                    </div>
                ...
                <div class="tabs-container">
                    ...
                    <div class="tabs">
                      ...
                      <!--       <li <?php  if($type=='credit1') { ?>class="active"<?php  } ?>><a data-toggle="tab" href="#tab-1" data-rechargetype="credit1" aria-expanded="true"> 充值积分</a></li> -->
                            ...
                            <li <?php  if($type=='credit2') { ?>class="active"<?php  } ?>><a data-toggle="tab" href="#tab-2"  data-rechargetype="credit2" aria-expanded="true"> 充值余额</a></li>
                            <?php  } ?>
                            <!-- <?php if(cv('finance.recharge.credit3')) { ?>
                            <li <?php  if($type=='credit3') { ?>class="active"<?php  } ?>><a data-toggle="tab" href="#tab-3"  data-rechargetype="credit3" aria-expanded="true"> 余额转换押金</a></li>
                            <?php  } ?> -->
                        ...
                        <div class="tab-content ">
                            ...
                            <div id="tab-2" class="tab-pane <?php  if($type=='credit1') { ?>active<?php  } ?>">
