...
<script language='javascript'>
 ...
 <?php  if($_W['isfounder'] && $_W['routes']!='system.auth.upgrade') { ?>
    function check_wx_shop_upgrade() {
        require(['util'], function (util) {
            if (util.cookie.get('checkwxshopv2upgrade_sys')) {
                return;
            }
      ...
      function check_wx_shop_upgrade_hide() {
        require(['util'], function (util) {
            util.cookie.set('checkwxshopv2upgrade_sys', 1, 3600);
    ...
    $(function () {
        ...
        $('.img-thumbnail').each(function () {
            if ($(this).attr('src').indexOf('nopic.jpg') != -1) {
                $(this).attr('src', "<?php echo WX_SHOP_LOCAL;?>static/images/nopic.jpg");
            }
        })
