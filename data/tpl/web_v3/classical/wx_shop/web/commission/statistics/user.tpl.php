        ...
        <tr>
            <td style="overflow: visible">
               <div style="display: flex"  rel="pop" data-content="
                   ...
                   <img class="radius50" src='<?php  echo $row['pagent']['avatar'];?>' style='width:30px;height:30px;padding1px;border:1px solid #ccc'  onerror="this.src='../addons/wx_shop/static/images/nopic.png'"/>
                   <?php  } ?>
            ...
            <td >
                ...
                <img class="radius50" src='<?php  echo $row['avatar'];?>' style='width:30px;height:30px;padding1px;border:1px solid #ccc'  onerror="this.src='../addons/wx_shop/static/images/nopic.png'"/>
                <?php  } ?>
