...
<?php  if(count($list)>0) { ?>
        ...
        <table class="table table-hover table-responsive">
            ...
            <tr>
                ...
                <th style='width:180px;'>等级</th>
                <!-- <th style='width:80px;'>累计佣金<br/>打款佣金</th> -->
                <!-- <th style='width:80px;'>累计佣金</th> -->
                <th style='width:180px;'>下级分销商</th>
                <th style='width:180px;'>注册时间</br>审核时间</th>
           ...
           <tr >
                ...
                <td style="overflow: visible">
                    ...
                    <?php  if(!empty($row['parentavatar'])) { ?>
                         <img class='radius50' src='<?php  echo $row['parentavatar'];?>' style='width:20px;height:20px;padding1px;border:1px solid #ccc' onerror='this.src='../addons/wx_shop/static/images/noface.png''/>
                    <?php  } ?>
					   ...
					   ">
                        ...
                        <a href="<?php  echo webUrl('member/list/detail',array('id' => $row['id']));?>" title='查看会员信息' target='_blank' style="display: flex">
                            ...
                            <img class="radius50" src='<?php  echo tomedia($row['avatar'])?>' style='width:30px;height:30px;padding1px;border:1px solid #ccc' onerror="this.src='../addons/wx_shop/static/images/noface.png'"/>
                            <?php  } ?>
                ...
                <!-- <td><span class="text-danger"><?php  echo $row['commission_total'];?></span></td> -->
                ...
                <td>
                    ...
                    <span class='label <?php  if($row['status']==1) { ?>label-primary<?php  } else { ?>label-default<?php  } ?>'
										  ...
										  data-toggle='ajaxSwitch'                                                                                                                                                                                               data-confirm ='确认要<?php  if($row['status']==1) { ?>取消审核<?php  } else { ?>审核通过<?php  } ?>?'
