...
<html>
    <head>
        ...
        <title><?php  if(empty($this->merch_user) && $_W['shopset']['shop']['name']) { ?><?php  echo $_W['shopset']['shop']['name'];?><?php  } else if(!empty($this->merch_user) && $this->merch_user['merchname']) { ?><?php  echo $this->merch_user['merchname']?><?php  } else { ?>首页<?php  } ?></title>
        ...
        <link rel="stylesheet" type="text/css" href="<?php  echo WX_SHOP_LOCAL?>static/fonts/iconfont.css?v=2017070719">
        
        <script src="./resource/js/lib/jquery-1.11.1.min.js"></script>
        <script src='//res.wx.qq.com/open/js/jweixin-1.3.0.js'></script>
   <!-- <script src="../addons/wx_shop/static/js/dist/foxui/js/foxui.min.js"></script> -->
        <script src="<?php  echo WX_SHOP_LOCAL?>static/js/require.js"></script>
        <script src="<?php  echo WX_SHOP_LOCAL?>static/js/myconfig-app.js"></script>
