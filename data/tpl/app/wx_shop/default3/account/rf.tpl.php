            ...
            <div class="ls_conte flex flex-center">
                <div class="mobile_cont">
                    <div class="input_inp flex flex-ver">
                        <input class="name_input" type="text" placeholder="请输入用户名4~12无符号字母" onKeyUp="value=value.replace(/[\W]/g,'')" maxlength="11">
                    </div>
                </div>
                ...
                <div class="mobile_cont">
                    <div class="input_inp flex flex-ver">
                        <p>邀请码：</p>
                        <input class="code_num" type="text" placeholder="请输入邀请码" value="<?php  echo $sjyqm['rcode'];?>">
                    </div>
                </div>
