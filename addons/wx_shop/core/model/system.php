		...
		$shopmenu = array(
				...
				'items'    => array(
					array(
						...
						'items' => array(
							...
							array('title' => '系统信息', 'route' => 'notice', 'desc' => '系统公告'),
							array('title' => '活动中心', 'route' => 'hdnotice', 'desc' => '活动中心'),
							array('title' => '关于我们', 'route' => 'sd_about_us', 'desc' => '关于我们'),
			...
			'member'     => array(
				...
				'items'    => array(
					...
					array('title' => '会员等级大厅', 'route' => 'sd_level'),
					// array('title' => '添加银行', 'route' => 'bank'),
					array('title' => '添加会员头像', 'route' => 'avatar'),
					array('title' => '分销设置', 'route' => 'sd_distribution'),
					// array('title' => '会员返佣管理', 'route' => 'level'),
			...
			'grabsingle'     => array(
				...
				'subtitle' => '抢单管理',
				'icon'     => 'page',
				'route' => 'grabsingle.set',
				'items'    => array(
					array(
						'title' => '设置', 
						'items' => array(
							array('title' => '基本设置', 'route' => 'set'),
							array('title' => '首页文章设置', 'route' => 'set2'),
							array('title' => '抢单提示设置', 'route' => 'set3'),
							array('title' => '收款设置', 'route' => 'set4')
							)	
						),
			...
			'order'      => array(
				...
				'items'    => array(
					...
					array('title' => '全部订单', 'route' => 'sd_list', 'desc' => '全部订单列表', 'permmust' => 'order.sd_list'),
					// array(
					// 	'title' => '维权',
					// 	'route' => 'list',
					// 	'items' => array(
				...
				// 	'icon'     => 'member',
				// 	'items'    => array(
				// 		array('title' => '客服设置', 'route' => 'customer_set'),
				// 		array('title' => '客服聊天', 'route' => 'customer_chat'),
				// 		)
				// 	),
			// 'store'      => array(
			// 	'title'    => '门店',
				...
				'items'    => array(
					/*array(
						...
						'items' => array(
							...
							array('title' => '充值审核', 'route' => 'check'),
							// array('title' => '保证金解冻审核', 'route' => 'bzjjd'),
							array('title' => '余额明细', 'route' => 'credit2'),
							array('title' => '佣金明细', 'route' => 'credit_commission'),
							array('title' => '理财明显', 'route' => 'lcmx'),
						)
					),*/
					array(
						'title' => '财务',
						'route' => 'sd_log',
						'items' => array(
							array('title' => '余额明细', 'route' => 'gold'),
							array('title' => '买入审核', 'route' => 'recharge'),
							array('title' => '卖出审核', 'route' => 'withdrawal'),
						)
					),
					...
					/*array(
						...
						'route' => 'lcset',
						'items' => array(
							array('title' => '理财设置', 'route' => ''),
							// array('title' => '返佣管理', 'route' => 'fanyong'),
							)
						),*/
					//7322修改理财设置
					array(
