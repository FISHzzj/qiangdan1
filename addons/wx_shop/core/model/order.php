...
class Order_WxShopModel
{
	...
	public function setGiveBalance($orderid = '', $type = 0) 
	{
		...
		// pdo_update('wx_shop_order',array('balance'=>$balance),array('id'=>$orderid));
		pdo_insert('wx_shop_member_credit_log',array('uniacid'=>$_W['uniacid'],'openid'=>$order['openid'],'orderid'=>$orderid,'money'=>$balance,'type'=>3,'createtime'=>time()));
